...
public class ListSearchMoviesDTO {
    ...
    public ListSearchMoviesDTO(){}

    public ListSearchMoviesDTO(Dates dates, int page, List<SearchMovie> results, int total_pages, int total_results) {
        this.dates = dates;
        this.page = page;
